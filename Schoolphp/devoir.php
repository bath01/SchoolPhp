...
<body>
    ...
    <!-- Part 1 -->
    <div class="breadcrumb-option" style="background: url(image/bg_1.jpg) no-repeat;
     background-size: cover; background-position: top center; padding: 130px 0;">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="room__pic__slider">
                                        <div class="room__pic__item">
                                            <img src="image/langage C.jpg" alt="" width="100%" height="400px">
                                        </div>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="room__pic__slider">
                                        <div class="room__pic__item">
                                            <img src="image/html.jpg" alt="" width="100%" height="400px">
                                        </div>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="room__pic__slider">
                                        <div class="room__pic__item">
                                            <img src="image/math (2).jpg" alt="" width="100%" height="400px">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6 p-0 order-lg-1 order-md-1 col-md-6">
                    <div class="room__text">
                        ...
                        <ul>
                            <li><a style="color:#ff7900; font-weight: bold;" href="/programWeb.php">HTML && CSS</a></li>
                            <li><a style="color:#ff7900; font-weight: bold;" href="/programWeb.php">JAVASCRIPT</a></li>
                            <li><a style="color:#ff7900; font-weight: bold;" href="/programWeb.php">PHP</a></li>
                            <li><a style="color:#ff7900; font-weight: bold;" href="/programWeb.php">RESEAU</a></li>
                            <li><a style="color:#ff7900; font-weight: bold;" href="/programWeb.php">ANGLAIS</a></li>
                        </ul>
                        Cliquez simplement sur la matière de votre choix afin de retrouver les devoirs et Interrogations
                        <a href="/programWeb.php" class="btn btn-primary">Programmation Web</a>
                    </div>
                </div>

                <div class="col-lg-6 p-0 order-lg-3 order-md-3 col-md-6">
                    <div class="testimonial__slider owl-carousel pt-4">
                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item  active">
                                    <div class="room__pic__slider">
                                        <div class="room__pic__item">
                                            <img src="image/reseau1.jpg" alt="" width="100%" height="400px">
                                        </div>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="room__pic__slider">
                                        <div class="room__pic__item">
                                            <img src="image/merise.jpg" alt="" width="100%" height="400px">
                                        </div>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="room__pic__slider">
                                        <div class="room__pic__item">
                                            <img src="image/php.jpg" alt="" width="100%" height="400px">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6 ps-lg-5 order-lg-4 order-md-4 col-md-6 pt-4">
                    <div class="room__text right__text">
                        ...
                        <ul>
                            <li><a style="color:#ff7900; font-weight: bold;" href="program.html">JAVA</a></li>
                            <li><a style="color:#ff7900; font-weight: bold;" href="program.html">C#</a></li>
                            <li><a style="color:#ff7900; font-weight: bold;" href="program.html">LANGAGE C</a></li>
                            <li><a style="color:#ff7900; font-weight: bold;" href="program.html">PYTHON</a></li>
                            <li><a style="color:#ff7900; font-weight: bold;" href="program.html">ALGORITHME</a></li>
                            <li><a style="color:#ff7900; font-weight: bold;" href="program.html">MATHS</a></li>
                        </ul>
                        Cliquez simplement sur la matière de votre choix afin de retrouver les devoirs et Interrogations
                        <a href="program.html" class="btn btn-primary">Programmation</a>
                    </div>
                </div>
            </div>
        </div>
