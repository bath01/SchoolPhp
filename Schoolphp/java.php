    ...
    <div class="container pt-5 pb-5">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 pt-3">
                <a href="image/java.png">
                    <img src="image/java.png" alt="" class="img-fluid rounded" />
                </a>
            </div>
            <div class="col-lg-6 col-md-12 pt-3">
                <a href="image/java1.png">
                    <img src="image/java1.png" alt="" class="img-fluid rounded" />
                </a>
            </div>
            <div class="col-lg-6 col-md-12 pt-3">
                <a href="image/java2.png">
                    <img src="image/java2.png" alt="" class="img-fluid rounded" />
                </a>
            </div>
            <div class="col-lg-6 col-md-12 pt-3">
                <a href="image/java3.png">
                    <img src="image/java3.png" alt="" class="img-fluid rounded" />
                </a>
            </div>
            <h2 style="font-weight: bold; text-decoration: underline" class="pt-3">
                Mes Interrogations de Java
            </h2>
            <div class="col-lg-12 col-md-12 pt-3">
                <b>
                    Exercice 1 <br />
                    Utiliser les Algo de la partie <a href="./Algo.php">Algo</a> pour les
                    traduire en Java
                </b>
            </div>
        </div>
