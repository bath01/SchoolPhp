...
<body>
    ...
    <!-- Part 1 -->
    <div class="breadcrumb-option" style="background: url(image/7.jpg) no-repeat;
     background-size: cover; background-position: center center; padding: 130px 0;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-6 text-center">
                    <div class="breadcrumb__text">
                        <h1 style="color: #ff7900;">RESEAU</h1>
    ...
    <div class="container pt-5">
        <div class="row">
            <div class="col-lg-5 mr-auto mb-5 align-self-center">
                <div class="mb-5">
                    <h2 style="font-weight: bold; color: black; text-decoration: underline;">Mes Devoirs</h2>
                    <p>Nous avons eu seulement des Devoirs</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid pb-5">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <a href="image/reseau.jpg">
                    <img src="image/reseau.jpg" alt="" class="img-fluid">
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="image/reseau1.jpg">
                    <img src="image/reseau1.jpg" alt="" class="img-fluid">
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="image/reseau (2).jpg">
                    <img src="image/reseau (2).jpg" alt="" class="img-fluid">
                </a>
            </div>
            <div class="col-lg-4 col-md-6 pt-4">
                <a href="image/reseau (3).jpg">
                    <img src="image/reseau (3).jpg" alt="" class="img-fluid">
                </a>
            </div>
            <div class="col-lg-4 col-md-6 pt-4">
                <a href="image/reseau2.jpg">
                    <img src="image/reseau2.jpg" alt="" class="img-fluid">
                </a>
            </div>
            <div class="col-lg-4 col-md-6 pt-4">
                <a href="image/reseau3.jpg">
                    <img src="image/reseau3.jpg" alt="" class="img-fluid">
                </a>
            </div>
            <div class="col-lg-6 col-md-6 pt-4">
                <a href="image/reseau (7).jpg">
                    <img src="image/reseau (7).jpg" alt="" class="img-fluid">
                </a>
            </div>
            <div class="col-lg-6 col-md-6 pt-4">
                <a href="image/reseau (8).jpg">
                    <img src="image/reseau (8).jpg" alt="" class="img-fluid">
                </a>
            </div>
        </div>
    </div>
