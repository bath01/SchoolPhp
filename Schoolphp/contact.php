...
if (isset($_POST['titi'])) {
    ...
    $number = htmlspecialchars(trim($_POST['contact']));
        ...
        if (isset($email) and !empty($email)) {
            if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
                if (isset($number) and !empty($number)) {
                    if (strlen($number) >= 10) {
                        $req = $dbb->prepare("INSERT INTO inscris(name,email,contact) VALUES(?,?,?)");
                        $req->execute([$nom, $email, $number]);
...
<body>
    ...
    <div class="breadcrumb-option" style="
        background: url(image/Stages.jpg) no-repeat;
                ...
                <div class="col-lg-5 col-md-6 col-sm-5">
                    <div class="contact__widget">
                        ...
                        <div class="contact__widget__time">
                            <h4 style="color: black; font-weight: bold">Notre Temps</h4>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="contact__widget__time__item">
                                        <ul>
                                            <li>Lundi - Vendredi</li>
                                            <li><span>8 h - 21 h</span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <div class="col-lg-6 offset-lg-1 col-md-6 col-sm-7">
                    <div class="contact__form">
                        ...
                        <form action="#" method="POST">
                            ...
                            <input type="text" name="contact" required id="" placeholder="Contact">
                            <button name="titi" type="submit">Envoyer</button>
                        </form>
                    </div>
                </div>
                <div style="text-align: center; margin-bottom: 10px; margin-top: 10px; font-size: 20px;">
                    <b style="padding-bottom: 10px;">Donnez votre avis svp</b><br><a href="commentaire.php"
                        class="btn btn-primary">Commentaire</a>
                </div>
            </div>
        </div>
    </section>
