...
<body>
    ...
    <!-- Part 1 -->
    <div class="breadcrumb-option" style="background: url(image/9.jpg) no-repeat;
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card h-100">
                    <img src="image/2.jpg" height="200px" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">JAVA</h5>
                        <p class="card-text">Les devoirs et interrogations sont là sur ce lien ci-dessous.</p>
                        <a href="./java.php" class="btn btn-primary">Java</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Les devoirs et interrogations sont là sur ce lien ci-dessous.</p>
                        <a href="./csharp.php" class="btn btn-primary">Csharp</a>
                    </div>
                </div>
            </div>
            <div class="col">
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">LANGAGE C</h5>
                        <p class="card-text">Les devoirs et interrogations sont là sur ce lien ci-dessous.</p>
                        <a href="./c.php" class="btn btn-primary">Langage C</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Les devoirs et interrogations sont là sur ce lien ci-dessous.</p>
                        <a href="./Algo.php" class="btn btn-primary">Algo</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Les devoirs et interrogations sont là sur ce lien ci-dessous.</p>
                        <a href="./Math.php" class="btn btn-primary">Maths</a>
                    </div>
                </div>
            </div>
        </div>
