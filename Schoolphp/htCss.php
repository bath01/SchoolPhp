...
<body>
    ...
    <!-- Part 1 -->
    <div class="breadcrumb-option" style="background: url(image/6.jpg) no-repeat;
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <b style="font-size: 40px;">
                    Concevoir une page avec des formulaires avec Html et Css...
                </b>
            </div>
            <div class="col-lg-4 col-md-6">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <b style="font-size: 40px;">
                    Mettre en place Un site moyen juste pour afficher les notes des etudiants dans une harmonie
                    parfaite.
                </b>
            </div>
            <div class="col-lg-4 col-md-6">
                ...
                <b style="font-size: 40px;">
                    Citez tous les propriétés que vous connaissez en Css ....
                </b>
            </div>
            <div class="col-lg-4 col-md-6">
                <i style="text-decoration: underline;">Exercice 4 : </i>
                <b style="font-size: 40px;">
                    Concevoir Un site complet d'e-commerce en Html et Css....
                </b>
            </div>
        </div>
    </div>
    ...
    <div class="container pt-5">
        <div class="row">
            <div class="col-lg-5 mr-auto mb-5 align-self-center">
                <div class="mb-5">
                    <h2 style="font-weight: bold; color: black; text-decoration: underline;">Mes Interrogations</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid pb-5">
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <a href="image/ht3.jpg">
                    <img src="image/ht3.jpg" alt="" class="img-fluid">
                </a>
            </div>

            <div class="col-lg-6 col-md-6">
                <a href="image/ht2.jpg">
                    <img src="image/ht2.jpg" alt="" class="img-fluid">
                </a>
            </div>

            <div class="col-lg-6 col-md-6 pt-2">
                <a href="image/ht1.jpg">
                    <img src="image/ht1.jpg" alt="" class="img-fluid">
                </a>
            </div>

            <div class="col-lg-6 col-md-6 pt-2">
                <a href="image/ht.jpg">
                    <img src="image/ht.jpg" alt="" class="img-fluid">
                </a>
            </div>
        </div>
    </div>
