...
<body>
    ...
    <div class="breadcrumb-option" style="background: url(image/4.jpg) no-repeat;
    ...
    <div class="container pt-5 pb-5">
        <div class="row">
            <h2 style="font-weight: bold; text-decoration: underline;">Mes Devoirs de Langage C</h2>
            <b style="font-size: 25px;"><em>Des epreuves plus ou moins difficile.</em></b>
            <div class="col-lg-12 col-md-12 pt-3">
                <a href="image/langage C.jpg">
                    <img src="image/langage C.jpg" alt="" class="img-fluid rounded">
                </a>
            </div>
            <h2 style="font-weight: bold; text-decoration: underline;" class="pt-3">Mes Interrogations du Langage C</h2>
            <div class="col-lg-12 col-md-12 pt-3">
                <b>
                    Exercice 1 <br>
