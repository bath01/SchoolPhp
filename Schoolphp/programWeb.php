...
<body>
    ...
    <!-- Part 1 -->
    <div class="breadcrumb-option" style="background: url(image/13.jpg) no-repeat;
    ...
    <div class="container pt-5" style="font-size: 30px;">
        <div class="row">
            <p>
                Voulez-vous télécharger les images ??? c'est simple <b>Cliquez simplement sur l'image</b> et télécharger
                là!!
                <b>Je précise pas sur cette page mais sur la page de la matière choisi.</b>
            </p>
        </div>
    </div>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card h-100">
                    <img src="image/6.jpg" height="200px" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">HTML && CSS</h5>
                        <p class="card-text">Les devoirs et interrogations sont là sur ce lien ci-dessous.</p>
                        <a href="./htCss.php" class="btn btn-primary">Html&&Css</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Les devoirs et interrogations sont là sur ce lien ci-dessous.</p>
                        <a href="./js.php" class="btn btn-primary">JavaScript</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Les devoirs et interrogations sont là sur ce lien ci-dessous.</p>
                        <a href="./Php.php" class="btn btn-primary">Php</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    <img src="image/7.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">RESEAU</h5>
                        <p class="card-text">Les devoirs et interrogations sont là sur ce lien ci-dessous.</p>
                        <a href="./reseau.php" class="btn btn-primary">Reseau</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Les devoirs et interrogations sont là sur ce lien ci-dessous.</p>
                        <a href="./Anglais.php" class="btn btn-primary">Anglais</a>
                    </div>
                </div>
            </div>
        </div>
