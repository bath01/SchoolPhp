...
<body>
    ...
    <div class="breadcrumb-option" style="background: url(image/3.jpg) no-repeat;
    ...
    <div class="container pt-5 pb-5">
        <div class="row">
            <h2 style="font-weight: bold; text-decoration: underline;">Mes Devoirs de Python</h2>
            <b style="font-size: 25px;"><em>Des epreuves plus ou moins difficile.</em></b>
            <div class="col-lg-6 col-md-12 pt-3">
                <a href="image/python.png">
                    <img src="image/python.png" alt="" class="img-fluid rounded">
                </a>
            </div>
            <div class="col-lg-6 col-md-12 pt-3">
                <a href="image/python1.png">
                    <img src="image/python1.png" alt="" class="img-fluid rounded">
                </a>
            </div>
            <div class="col-lg-6 col-md-12 pt-3">
                <a href="image/python2.png">
                    <img src="image/python2.png" alt="" class="img-fluid rounded">
                </a>
            </div>
            <div class="col-lg-6 col-md-12 pt-3">
                <a href="image/python1.png">
            ...
            <h2 style="font-weight: bold; text-decoration: underline;" class="pt-3">Mes Interrogations de Python</h2>
            <div class="col-lg-12 col-md-12 pt-3">
                <b>
                    Exercice 1 <br>
                    Utiliser les Algo de la partie <a href="./Algo.php">Algo</a> pour les traduire en Python
                </b>
