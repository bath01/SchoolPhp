    ...
    <div class="container-fluid pb-5">
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <a href="image/php4.jpg">
                    <img src="image/php4.jpg" alt="" class="img-fluid" />
                </a>
            </div>
            <div class="col-lg-6 col-md-6">
                <a href="image/php3.jpg">
                    <img src="image/php3.jpg" alt="" class="img-fluid" />
                </a>
            </div>
            <div class="col-lg-6 col-md-6">
                <a href="image/php2.jpg">
                    <img src="image/php2.jpg" alt="" class="img-fluid" />
                </a>
            </div>
            <div class="col-lg-6 col-md-6">
                <a href="image/php1.jpg">
                    <img src="image/php1.jpg" alt="" class="img-fluid" />
                </a>
            </div>
        </div>
    </div>
